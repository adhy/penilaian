            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA INDIKATOR</h3>
                    </div>
        
        <div class="box-body">
        <?=$this->session->flashdata('message')?>
        <div style="padding-bottom: 10px;"'>
        <?php echo anchor(site_url('indikator/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?></div>
                    ...
                    columns: [
                        {
                            "data": "id_indikator",
                            "orderable": false
                        },{"data": "nama_level"},{"data": "indikator"},{"data": "tahun"},
                        {
                            "data" : "action",
                            "orderable": false,
