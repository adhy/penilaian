		...
		<div class="box box-warning box-solid">
			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Total </td><td><input type="text" class="form-control" name="total" id="total" placeholder="Total" value="<?php echo $total; ?>" /> <?php echo form_error('total') ?></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('ggrafikview') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
